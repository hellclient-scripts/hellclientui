            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Text('禁用Hidpi文字渲染，降低画质，提升效率')
                ],
              ),
              Row(
                children: [
                  ...
                  const Text('强制使用桌面模式,在小屏幕上会缩小界面，难以操作')
                ],
              ),
              Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            final input = await AppUI.promptTextArea(context,
                                '导入显示设置', '请导入hcui-config:开头的设置输出', '', '');
                            if (input != null) {
                              if (input.startsWith('hcui-config:')) {
                                try {
                                  final import = RenderConfig.fromJson(
                                      jsonDecode(utf8.decode(base64Decode(input
                                          .replaceFirst('hcui-config:', '')))));
                                  config = import;
                                  setState(() {});
                                  return;
                                } catch (e) {
